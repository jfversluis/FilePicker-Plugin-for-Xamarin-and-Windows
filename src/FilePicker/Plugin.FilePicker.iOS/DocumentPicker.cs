...
{
    internal class DocumentPicker : NSObject
    {
        /// <summary>
        ...
        /// <param name="sender">sender object (document picker)</param>
        /// <param name="args">event args</param>
        private void DocumentPicker_WasCancelled(object sender, EventArgs args)
        {
            var tcs = Interlocked.Exchange(ref this.completionSource, null);
            tcs.SetResult(null);
        }
        ...
        public Task<FileData> PickMediaAsync(string[] allowedTypes)
        {
